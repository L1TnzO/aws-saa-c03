> **BRONZE Markdown** — `GOV-09` · Servicio: **AWS Budgets** · Fase 8 · Dominios examen: D4
> URL oficial: https://docs.aws.amazon.com/cost-management/latest/userguide/budgets-managing-costs.html
> Título oficial: Managing your costs with AWS Budgets
...
Reserved Instances (RIs) or Savings Plans. If you're new to AWS Budgets, see Best practices for AWS Budgets (./budgets-best-practices.html).
...
Amazon SNS topic, to an email address, or to both. For more information, see Creating an Amazon SNS topic for budget notifications (./budgets-sns-policy.html).
...
budget if they receive access to the management account. For more information, see Overview of managing access permissions (./control-access-billing.html). For more
