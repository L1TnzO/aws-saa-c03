> **BRONZE Markdown** — `GOV-03` · Servicio: **AWS Config** · Fase 8 · Dominios examen: D1
> URL oficial: https://docs.aws.amazon.com/config/latest/developerguide/WhatIsConfig.html
> Título oficial: What Is AWS Config? - AWS Config
...
- Ways to Use AWS Config (#common-scenarios)
