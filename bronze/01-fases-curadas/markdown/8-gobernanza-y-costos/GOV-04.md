> **BRONZE Markdown** — `GOV-04` · Servicio: **AWS CloudFormation** · Fase 8 · Dominios examen: D2
> URL oficial: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html
> Título oficial: What is CloudFormation? - AWS CloudFormation
...
AWS CLI (https://docs.aws.amazon.com/cli/latest/reference/cloudformation), AWS SDKs
(https://aws.amazon.com/developer/tools/), and through several integrations.

For an introduction to CloudFormation, see How CloudFormation works (./cloudformation-overview.html).

To start using CloudFormation, see Creating your first stack (./gettingstarted.walkthrough.html).
...
Simplify infrastructure management (#welcome-simplify-infrastructure-management)
- Quickly replicate your infrastructure (#welcome-quickly-replicate-your-infrastructure)
- Easily control and track changes to your infrastructure (#welcome-easily-control-and-trach-changes)
- Getting started with CloudFormation (#getting-started)
- Related information (#welcome-related-information)
