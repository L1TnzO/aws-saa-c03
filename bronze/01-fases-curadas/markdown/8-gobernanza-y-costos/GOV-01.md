> **BRONZE Markdown** — `GOV-01` · Servicio: **Amazon CloudWatch** · Fase 8 · Dominios examen: D2, D3
> URL oficial: https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html
> Título oficial: What is Amazon CloudWatch? - Amazon CloudWatch
...
Metrics (./working_with_metrics.html) collect and track key performance data at user-defined intervals. CloudWatch provides two types of metrics: OpenTelemetry Metrics (./metrics-otel-recommended.html) (recommended) and CloudWatch Metrics (Classic) (./metrics-classic.html). Many AWS services (./aws-services-cloudwatch-metrics.html) automatically report metrics into CloudWatch, and you can also publish your own custom metrics, either with OpenTelemetry (OTLP) (./metrics-otel-send.html) or with the PutMetricData API (./publishingMetrics.html).
...
OpenTelemetry (./CloudWatch-OpenTelemetry-Sections.html).
...
| Contact Us | A central contact point for inquiries concerning AWS billing, account, events, abuse, and so on. |
...
- OpenTelemetry support (#cloudwatch-otel-overview)
- Solutions catalog (#cloudwatch-solutions-overview)
- CloudWatch network monitoring (#cloudwatch-network-monitoring-overview)
- Billing and costs (#BillingPointer)
- Resources (#RelatedResources)
- ### Related resources

Amazon CloudWatch API Reference (https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/index.html)AWS CLI commands for Amazon CloudWatch (https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/)SDKs & Tools  (https://aws.amazon.com/tools/)
