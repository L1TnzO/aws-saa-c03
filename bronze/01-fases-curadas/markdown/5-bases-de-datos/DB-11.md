> **BRONZE Markdown** — `DB-11` · Servicio: **Amazon DynamoDB** · Fase 5 · Dominios examen: D2
> URL oficial: https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GlobalTables.html
> Título oficial: Global tables - multi-active, multi-Region replication

*Amazon DynamoDB global tables* is a fully managed,
...
- Global tables core concepts (./globaltables-CoreConcepts.html)
- DynamoDB same-account global table (./globaltables-SameAccount.html)
- DynamoDB multi-account global tables (./globaltables-MultiAccount.html)
- Understanding Amazon DynamoDB billing for global tables (./global-tables-billing.html)
- DynamoDB global tables versions (./V2globaltables_versions.html)
- Best practices for global tables (./globaltables-bestpractices.html)
