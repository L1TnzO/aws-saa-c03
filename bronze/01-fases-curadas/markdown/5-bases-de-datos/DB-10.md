> **BRONZE Markdown** — `DB-10` · Servicio: **Amazon DynamoDB** · Fase 5 · Dominios examen: D3, D4
> URL oficial: https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.ReadWriteCapacityMode.html
> Título oficial: DynamoDB throughput capacity - Amazon DynamoDB
...
the table. For more information, see DynamoDB on-demand capacity mode (./on-demand-capacity-mode.html).
...
application. For more information, see DynamoDB provisioned capacity mode (./provisioned-capacity-mode.html).
