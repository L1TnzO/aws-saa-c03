> **BRONZE Markdown** — `CMP-19` · Servicio: **AWS Fargate** · Fase 3 · Dominios examen: D2, D3, D4
> URL oficial: https://docs.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html
> Título oficial: Architect for AWS Fargate for Amazon ECS
...
Walkthroughs (#fargate-walkthrough)
- Capacity providers (#fargate-spot)
- Task definitions (#fargate-task-defintion)
- Platform versions (#fargate-platform-versions)
- Service load balancing (#fargate-tasks-services-load-balancing)
- Usage metrics (#fargate-usage-metrics)
- ### Related resources

Amazon ECS API Reference (https://docs.aws.amazon.com/AmazonECS/latest/APIReference/index.html)AWS CLI commands for Amazon ECS (https://docs.aws.amazon.com/cli/latest/reference/ecs/)SDKs & Tools  (https://aws.amazon.com/tools/)
