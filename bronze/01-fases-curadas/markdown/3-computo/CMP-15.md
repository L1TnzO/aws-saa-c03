> **BRONZE Markdown** — `CMP-15` · Servicio: **AWS Lambda** · Fase 3 · Dominios examen: D2, D3, D4
> URL oficial: https://docs.aws.amazon.com/lambda/latest/dg/welcome.html
> Título oficial: What is AWS Lambda? - AWS Lambda
...
- **Lambda
Functions (./lambda-functions-chapter.html)** – Run code in response to events or
...
- **Lambda
MicroVMs (./lambda-microvms-guide.html)** – Isolated compute environments with
...
How Lambda Functions and Lambda MicroVMs compare (#lambda-comparison)
- ### Related resources

AWS Lambda API Reference (https://docs.aws.amazon.com/lambda/latest/api/welcome.html)AWS CLI commands for AWS Lambda (https://docs.aws.amazon.com/cli/latest/reference/lambda/)SDKs & Tools  (https://aws.amazon.com/tools/)
