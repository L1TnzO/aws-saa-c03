> **BRONZE Markdown** — `CMP-04` · Servicio: **Amazon EC2** · Fase 3 · Dominios examen: D4
> URL oficial: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html
> Título oficial: Spot Instances - Amazon Elastic Compute Cloud
...
For a comparison of the different purchasing options for EC2 instances, see Amazon EC2 billing and purchasing options (./instance-purchasing-options.html).
...
- *EC2 instance rebalance recommendation* – Amazon EC2
...
- *Spot Instance interruption* – Amazon EC2 terminates, stops, or hibernates your
...
The following table lists the key differences between Spot Instances and On-Demand Instances (./ec2-on-demand-instances.html).
...
interrupted the Spot Instance. For more information, see Billing for interrupted Spot Instances (./billing-for-interrupted-spot-instances.html).
...
View Spot Instance pricing history (./using-spot-instances-history.html).
...
You can view the savings made from using Spot Instances for a single Spot Fleet (./Fleets.html) or for all Spot Instances.
...
see Savings from purchasing Spot Instances (./spot-savings.html).

### View billing

Your bill provides details about your service usage. For more information, see Viewing your bill (https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/getting-viewing-bill.html) in the
...
- Differences between Spot Instances and On-Demand Instances (#key-differences-spot-on-demand)
