> **BRONZE Markdown** — `CMP-06` · Servicio: **Savings Plans** · Fase 3 · Dominios examen: D4
> URL oficial: https://docs.aws.amazon.com/savingsplans/latest/userguide/what-is-savings-plans.html
> Título oficial: What are Savings Plans? - Savings Plans
...
full list of AWS services that are eligible for Savings Plans, see Services eligible for Savings Plans benefits (./sp-services.html).

###### Topics

- Savings Plans types (./plan-types.html)
- Compute Savings Plans and Reserved Instances (./sp-ris.html)
