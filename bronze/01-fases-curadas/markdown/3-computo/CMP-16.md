> **BRONZE Markdown** — `CMP-16` · Servicio: **AWS Lambda** · Fase 3 · Dominios examen: D3
> URL oficial: https://docs.aws.amazon.com/lambda/latest/dg/configuration-memory.html
> Título oficial: Configure Lambda function memory - AWS Lambda
...
When to increase memory (#configuration-memory-use-cases)
- Using the console (#configuration-memory-console)
- Using the AWS CLI (#configuration-memory-cli)
- Using AWS SAM (#configuration-memory-sam)
- Accepting function memory recommendations (console) (#configuration-memory-optimization-accept)
- ### Related resources
