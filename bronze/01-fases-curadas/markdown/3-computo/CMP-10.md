> **BRONZE Markdown** — `CMP-10` · Servicio: **Amazon EBS** · Fase 3 · Dominios examen: D3, D4
> URL oficial: https://docs.aws.amazon.com/ebs/latest/userguide/what-is-ebs.html
> Título oficial: What is Amazon Elastic Block Store?
...
instances. For more information, see Automate backups with Amazon Data Lifecycle Manager (./snapshot-lifecycle.html).
...
information, see Use EBS direct APIs to access the contents of an EBS snapshot (./ebs-accessing-snapshot.html).
- **Recycle Bin** — A data recovery service
that enables you to restore accidentally deleted EBS snapshots and EBS-backed AMIs.
For more information, see Recycle Bin (./recycle-bin.html).
...
see the AWS Command Line Interface User Guide (https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-welcome.html) and the ec2 commands (https://docs.aws.amazon.com/cli/latest/reference/ec2/).
...
AWS Tools for PowerShell User Guide (https://docs.aws.amazon.com/powershell/latest/userguide/pstools-welcome.html) and AWS Tools for PowerShell Cmdlet Reference (https://docs.aws.amazon.com/powershell/latest/reference/).
...
those resources for you. For more information, see the AWS CloudFormation User Guide (https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).
...
Build on AWS (https://aws.amazon.com/developer/tools/).
