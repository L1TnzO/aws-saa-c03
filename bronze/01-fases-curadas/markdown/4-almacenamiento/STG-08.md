> **BRONZE Markdown** — `STG-08` · Servicio: **Amazon S3** · Fase 4 · Dominios examen: D3
> URL oficial: https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html
> Título oficial: Best practices design patterns: optimizing Amazon S3 performance
...
and using prefixes, see Organizing objects using prefixes (./using-prefixes.html).
...
bucket, use Configuring fast, secure file transfers using Amazon S3 Transfer Acceleration (./transfer-acceleration.html).
...
Refer to the Performance guidelines for Amazon S3 (./optimizing-performance-guidelines.html) and Performance design patterns for Amazon S3 (./optimizing-performance-design-patterns.html) for the most current information
