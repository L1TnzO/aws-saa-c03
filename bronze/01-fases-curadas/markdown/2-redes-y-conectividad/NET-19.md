> **BRONZE Markdown** — `NET-19` · Servicio: **Elastic Load Balancing** · Fase 2 · Dominios examen: D3, D4
> URL oficial: https://docs.aws.amazon.com/elasticloadbalancing/latest/gateway/introduction.html
> Título oficial: What is a Gateway Load Balancer?
...
stickiness (./edit-target-group-attributes.html#flow-stickiness) to a specific target appliance using 5-tuple (default), 3-tuple, or 2-tuple.
The Gateway Load Balancer and its registered virtual appliance instances exchange application traffic using the
GENEVE (https://datatracker.ietf.org/doc/html/rfc8926) protocol on port
6081.
...
Partners (https://aws.amazon.com/elasticloadbalancing/partners/) have integrated and qualified their appliance software with AWS. You can
...
To create a Gateway Load Balancer using the AWS Management Console, see Getting started (./getting-started.html). To create a Gateway Load Balancer using the AWS Command Line Interface, see Getting started using the CLI (./getting-started-cli.html).
...
Gateway Load Balancer overview (#gateway-load-balancer-overview)
- Appliance vendors (#appliance-vendors)
