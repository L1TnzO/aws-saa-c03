> **BRONZE Markdown** — `NET-16` · Servicio: **Elastic Load Balancing** · Fase 2 · Dominios examen: D2, D3, D4
> URL oficial: https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/what-is-load-balancing.html
> Título oficial: What is Elastic Load Balancing?
...
For more information, see Elastic Load Balancing features (https://aws.amazon.com/elasticloadbalancing/features/).
...
you migrate to a current generation load balancer. For more information, see Migrate your Classic Load Balancer (https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/migrate-classic-load-balancer.html).
...
supported on Windows, macOS, and Linux. For more information, see AWS Command Line Interface (https://aws.amazon.com/cli/).
...
instances. For more information, see the Amazon EC2 User Guide (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/).
...
load balancer. For more information, see the Amazon EC2 Auto Scaling User Guide (https://docs.aws.amazon.com/autoscaling/ec2/userguide/).
...
route traffic to your containers. For more information, see the Amazon Elastic Container Service Developer Guide (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/).
...
balancers in one or more AWS Regions. For more information, see the AWS Global Accelerator Developer Guide (https://docs.aws.amazon.com/global-accelerator/latest/dg/).
...
see the Amazon Route 53 Developer Guide (https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/).
...
more information, see the AWS WAF Developer Guide (https://docs.aws.amazon.com/waf/latest/developerguide/).
...
Load balancer benefits (#load-balancer-benefits)
- Features of Elastic Load Balancing (#elb-features)
- Accessing Elastic Load Balancing (#elb-access-methods)
- Related services (#elb-related-services)
- Pricing (#load-balancer-pricing)
