> **BRONZE Markdown** — `NET-08` · Servicio: **AWS Transit Gateway** · Fase 2 · Dominios examen: D3, D4
> URL oficial: https://docs.aws.amazon.com/vpc/latest/tgw/what-is-transit-gateway.html
> Título oficial: What is AWS Transit Gateway for Amazon VPC?
...
- A network function attachment. For more information, see Network function attachments (./how-transit-gateways-work.html#nf-attachment-overview).
...
- How transit gateways work (./how-transit-gateways-work.html)
- Get started with transit gateways (./tgw-getting-started.html)
- Design best practices (./tgw-best-design-practices.html)
...
and Flexible cost allocation (./metering-policy.html).
...
Transit gateway concepts (#concepts)
- How to get started with transit gateways (#how-to-get-started)
- Work with transit gateways (#tgw-interfaces)
- Pricing (#pricing)
