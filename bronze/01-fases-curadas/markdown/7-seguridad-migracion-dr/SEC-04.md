> **BRONZE Markdown** — `SEC-04` · Servicio: **Secrets Manager** · Fase 7 · Dominios examen: D1
> URL oficial: https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html
> Título oficial: What is AWS Secrets Manager?
...
- Secret event
notifications (./secret-event-notifications.html)
...
Get started with Secrets Manager (#get-started)
- Compliance with standards (#compliance)
- Pricing (#asm_pricing)
