> **BRONZE Markdown** — `SEC-06` · Servicio: **Amazon GuardDuty** · Fase 7 · Dominios examen: D1
> URL oficial: https://docs.aws.amazon.com/guardduty/latest/ug/what-is-guardduty.html
> Título oficial: What is Amazon GuardDuty? - Amazon GuardDuty
...
GuardDuty Investigation (Preview) (./guardduty-investigation.html).
...
console or through the GuardDuty API. For more information, see Custom Detection Rules in GuardDuty (./custom-detection-rules.html).
...
which protection plans are enabled by default, see Using GuardDuty 30-day free trial (./guardduty-pricing.html#using-guardduty-30-day-free-trial).
