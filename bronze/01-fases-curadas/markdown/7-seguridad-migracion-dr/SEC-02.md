> **BRONZE Markdown** — `SEC-02` · Servicio: **AWS CloudHSM** · Fase 7 · Dominios examen: D1
> URL oficial: https://docs.aws.amazon.com/cloudhsm/latest/userguide/introduction.html
> Título oficial: What is AWS CloudHSM? - AWS CloudHSM
...
Non-FIPS mode offers all the keys and algorithms that are supported by AWS CloudHSM, regardless of FIPS approval. For more information, see AWS CloudHSM cluster modes (./cluster-hsm-types.html).
...
AWS CloudHSM also offers clusters in non-FIPS mode. See AWS CloudHSM clusters (./clusters.html) for more information.
