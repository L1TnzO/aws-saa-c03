> **BRONZE Markdown** — `INT-09` · Servicio: **Amazon Kinesis** · Fase 6 · Dominios examen: D3
> URL oficial: https://docs.aws.amazon.com/streams/latest/dev/introduction.html
> Título oficial: What is Amazon Kinesis Data Streams?

You can use Amazon Kinesis Data Streams to collect and process large streams (https://aws.amazon.com/streaming-data/) of data records in real time. You
...
AWS services. For information about Kinesis Data Streams features and pricing, see Amazon Kinesis Data Streams (https://aws.amazon.com/kinesis/streams/).
...
For more information about AWS big data solutions, see Big Data on AWS (https://aws.amazon.com/big-data/). For more information about
...
Connector (https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-kinesis.html).
