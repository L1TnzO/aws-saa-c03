> **BRONZE Markdown** — `EXAM-03` · Servicio: **AWS Certification** · Fase 0 · Dominios examen: EXAM
> URL oficial: https://d1.awsstatic.com/training-and-certification/docs-sa-assoc/AWS-Certified-Solutions-Architect-Associate_Exam-Guide_C03.pdf
> Título oficial: AWS Certified Solutions Architect - Associate (SAA-C03) Exam Guide (v1.0, 17 páginas)
> Nota: documento PDF oficial; el texto fue extraído localmente con pdftotext/pypdf.
