> **BRONZE Markdown** — `EXAM-02` · Servicio: **AWS Certification** · Fase 0 · Dominios examen: EXAM
> URL oficial: https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03/solutions-architect-associate-03.html
> Título oficial: AWS Certified Solutions Architect - Associate (SAA-C03) - AWS Certified Solutions Architect
...
- Content Domain 1: Design Secure Architectures (./solutions-architect-associate-03-domain1.html)
- Content Domain 2: Design Resilient Architectures (./solutions-architect-associate-03-domain2.html)
- Content Domain 3: Design High-Performing Architectures (./solutions-architect-associate-03-domain3.html)
- Content Domain 4: Design Cost-Optimized Architectures (./solutions-architect-associate-03-domain4.html)
- Technologies and Concepts (./saa-technologies-concepts.html)
- Mentions of AWS Services on the Exam (./saa-service-mentions.html)
- In-Scope AWS Services (./saa-03-in-scope-services.html)
...
- Content Domain 1: Design Secure Architectures (30% of scored content) (./solutions-architect-associate-03-domain1.html)
- Content Domain 2: Design Resilient Architectures (26% of scored content) (./solutions-architect-associate-03-domain2.html)
- Content Domain 3: Design High-Performing Architectures (24% of scored content) (./solutions-architect-associate-03-domain3.html)
- Content Domain 4: Design Cost-Optimized Architectures (20% of scored content) (./solutions-architect-associate-03-domain4.html)
